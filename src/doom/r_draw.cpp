...
void R_InitTranslationTables (void)
{
    ...
    translationtables = Z_New<unsigned char>(PU_STATIC, 256*3);
...
{ 
    ...
    if (background_buffer == NULL)
    {
        background_buffer = Z_New<pixel_t>( PU_STATIC, MAXWIDTH * (MAXHEIGHT - SBARHEIGHT));
    }
